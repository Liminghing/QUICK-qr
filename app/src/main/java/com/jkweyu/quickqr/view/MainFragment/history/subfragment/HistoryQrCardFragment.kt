...
class HistoryQrCardFragment(): BaseFragment<FragmentHistoryQrCardLayoutBinding>(R.layout.fragment_history_qr_card_layout) {
    override fun initView() {
        binding.apply {
            val mainViewModel = ViewModelProvider(requireActivity())[MainViewModel::class.java]
            Log.d("dfgjkl","HistoryQrCardFragment ${mainViewModel.qrCodeList.value} ")
            binding.cardFragViewModel = mainViewModel
        }
    }
}