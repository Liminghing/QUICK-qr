...
import com.jkweyu.quickqr.databinding.FragmentChoiceTextBinding
import com.jkweyu.quickqr.view.FrameFragment.FrameFragment
import com.jkweyu.quickqr.viewmodel.FrameFragmentViewModel

class ChoiceTextFragment(): BaseFragment<FragmentChoiceTextBinding>(R.layout.fragment_choice_text) {
    ...
    override fun initView() {
        binding.apply {
            ...
            button.setOnClickListener {
                ...
                frameFragmentViewModel.setType(0)
            }
        }
    }
}
